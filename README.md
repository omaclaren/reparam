...
- `repressilator_augmented_iir_diagnostic.jl` - Compare the local invariant-image structure for mRNA-only, mRNA+protein 1, and mRNA+all-proteins auxiliary maps using a saved repressilator result.
...
julia --project=. repressilator_augmented_iir_diagnostic.jl path/to/repressilator_results.jls
```
