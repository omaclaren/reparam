...
# True parameters - EXACT VALUES FROM examples/repressilator.jl
θ_true = [0.008, 0.009, 0.010,      # α₀ (basal transcription)
          1.0, 1.2, 1.5,             # α (regulated transcription)
          0.02, 0.025, 0.015,        # β (translation)
          30.0, 28.0, 32.0,          # K (inhibition constants)
          0.006, 0.0055, 0.0065,     # k_degm (mRNA degradation)
          0.0012, 0.0011, 0.0013]    # k_degp (protein degradation)
