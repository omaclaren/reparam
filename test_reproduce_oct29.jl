...
println("="^70)
println("REPRODUCING OCT 29 REPRESSILATOR 2D PROFILE")
...
t_2d = @elapsed begin
    θ_2d_vals, ll_2d_vals = ReparamTools.profile_target(
        ...
        n_chunks=USE_DISTRIBUTED ? N_WORKERS : nothing,
...
plt = contourf(β1_values, K1_values, like_grid,
              ...
              xlabel="β₁", ylabel="K₁",
              title="Repressilator 2D Profile: (β₁, K₁) [REPRODUCTION]",
              colorbar=false,
              size=(800, 700))
...
output_file = "repressilator_2D_REPRODUCTION_oct29.png"
savefig(plt, output_file)
println("✓ Figure saved: ", output_file)

println("\n" * "="^70)
println("COMPARISON WITH OCT 29 PLOT:")
println("  Original: repressilator_2D_distributed_beta1_K1.png")
println("  Reproduction: ", output_file)
println("  Expected: Clean diagonal ridge from lower-left to upper-right")
println("="^70)
